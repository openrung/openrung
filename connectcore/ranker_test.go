...
func rankRelay(id string) brokerapi.RelayDescriptor {
...
func rank(cands []brokerapi.RelayDescriptor, maxProbes int, probe func(context.Context, string, int) (int64, error)) []rankedRelay {
...
func TestRankByTCPLatencySortsByLatencyBucket(t *testing.T) {
	cands := []brokerapi.RelayDescriptor{rankRelay("a"), rankRelay("b"), rankRelay("c")}
...
func TestRankByTCPLatencySinksFailedProbesWithoutDropping(t *testing.T) {
	...
	// 1.5s probe gave up.
	cands := []brokerapi.RelayDescriptor{rankRelay("dead"), rankRelay("slow"), rankRelay("fast")}
...
func TestRankByTCPLatencyKeepsUnprobedTailInBrokerOrder(t *testing.T) {
	cands := []brokerapi.RelayDescriptor{rankRelay("r1"), rankRelay("r2"), rankRelay("r3"), rankRelay("r4"), rankRelay("r5")}
...
func TestRankByTCPLatencySingleCandidateSkipsProbe(t *testing.T) {
	...
	ranked := rank([]brokerapi.RelayDescriptor{rankRelay("only")}, RelayRankMaxProbes, probe)
...
func TestRankByTCPLatencyZeroMillisecondProbeRanksAsReachable(t *testing.T) {
	...
	cands := []brokerapi.RelayDescriptor{rankRelay("far"), rankRelay("near"), rankRelay("dead")}
...
func TestRankByTCPLatencyProbesConcurrently(t *testing.T) {
	...
	const want = 4
	cands := []brokerapi.RelayDescriptor{rankRelay("r1"), rankRelay("r2"), rankRelay("r3"), rankRelay("r4")}
...
func TestRankByTCPLatencyBoundsEveryProbeByTheRankTimeout(t *testing.T) {
	...
	cands := []brokerapi.RelayDescriptor{rankRelay("a"), rankRelay("b")}
...
func TestLadderOrderAnnotateLeavesProbeAbsentForUnrankedLadder(t *testing.T) {
	...
	cands := []brokerapi.RelayDescriptor{rankRelay("a")}
