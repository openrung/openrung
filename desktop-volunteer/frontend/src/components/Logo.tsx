// The OpenRung mark, copied from desktop/frontend/src/components/Logo.tsx: a
// white ladder on the brand-green rounded square. Inlined as SVG (not an
// imported asset) so it renders with zero network, matching the app's
// fully-offline, bundled-assets posture.
