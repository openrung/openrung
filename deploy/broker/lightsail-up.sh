...
IMAGE="${OPENRUNG_IMAGE:-ghcr.io/openrung/openrung-broker:main@sha256:d39e6a6e78fc72e846ddcce37f4a34cd97008c0a419704c415080f391e586c91}"
...
NAME="${1:-broker-$(openrung_random_label)}"
IPNAME="${NAME}-ip"
